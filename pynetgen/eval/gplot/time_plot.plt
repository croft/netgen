...
plot 'encodings.dat' using 2:3:4:xtic(1) title col lc rgb "#920000", \
     ...
     '' using 8:9:10 title col lc rgb "#a6a6a6"
...
plot NaN t "Drop Spec" w boxes lc rgb "#920000", \
     NaN t "FW Spec" w boxes lc rgb "#006ddb", \
     NaN t "Reroute Spec" w boxes lc rgb "#a6a6a6"
