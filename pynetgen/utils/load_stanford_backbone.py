...
def load_stanford_backbone_ntf():
    ...
    for rtr_name in rtr_names:
        f = TF(1)
        f.load_object_from_file("../data_set/tf_stanford_backbone/%s.tf"%rtr_name)
...
def load_stanford_backbone_ttf():
    ...
    '''
    f = TF(1)
    f.load_object_from_file("../data_set/tf_stanford_backbone/backbone_topology.tf")
    return f
...
def load_stanford_backbone_port_to_id_map():
    return load_port_to_id_map("../data_set/tf_stanford_backbone")
...
def generate_stanford_backbne_one_layer_tf():
    ...
    for rtr_name in rtr_names:
        ...
        f.save_object_to_file("../data_set/tf_stanford_backbone/%s_one_layer.tf"%rtr_name)
