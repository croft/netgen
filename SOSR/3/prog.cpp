...
int main()
{
	...
	routers["10.0.1.8"]= 8; 
	routers["10.0.1.9"]= 9; 
	routers["10.0.1.10"]= 10;
	routers["10.0.1.11"]= 11;
	#endif
	...
	#else
	abs_topo.push_back(make_pair(1,4));
	abs_topo.push_back(make_pair(4,3));
	abs_topo.push_back(make_pair(4,8));
	abs_topo.push_back(make_pair(3,5));
	abs_topo.push_back(make_pair(5,2));
	abs_topo.push_back(make_pair(5,6));
	abs_topo.push_back(make_pair(5,7));
	abs_topo.push_back(make_pair(5,8));
	abs_topo.push_back(make_pair(6,10));
	abs_topo.push_back(make_pair(7,8));
	abs_topo.push_back(make_pair(7,10));
	abs_topo.push_back(make_pair(8,9));
	abs_topo.push_back(make_pair(9,10));
	abs_topo.push_back(make_pair(6,11));
...
//	}
	...
	#else
	abs_R[make_pair(1,1)] = 4; 
	abs_R[make_pair(4,1)] = 8; 
	abs_R[make_pair(8,1)] = 7; 
	abs_R[make_pair(2,1)] = 5; 
	abs_R[make_pair(5,1)] = 7; 
	abs_R[make_pair(7,1)] = 10;
   
    abs_R[make_pair(3,1)] = 0;
    abs_R[make_pair(6,1)] = 0;
    abs_R[make_pair(9,1)] = 0;
...
//	{
//		abs_fw.push_back( routers[ *it] ) ; 
//	}
    
    
    abs_fw.push_back(routers["10.0.3.102"]);//86
    
    
	#else
	abs_fw.push_back(6);
//	abs_fw.push_back(9); //remove 9
	#endif
...
//        b = b && R ( c.int_val(9) , c.int_val(1) ) == c.int_val(0) ;
        ...
        for(int i = 0; i< abs_src.size(); i++ )
        {
            b = b && f1( c.int_val(abs_src[i]), c.int_val(1))  == c.bool_val(false) ;
