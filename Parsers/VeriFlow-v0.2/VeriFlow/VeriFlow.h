...
public:
	...
	bool getAllEquivalenceClasses(vector< EquivalenceClass >& vFinalPacketClasses, vector< vector< Trie* > >& vFinalTries);
	ForwardingGraph* getForwardingGraph(vector<Trie *> t, EquivalenceClass packetClass);	
