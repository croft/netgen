...
#include <stdint.h>
// #include <sys/wait.h>
#include "../veriflow-util/net.h"
#include "../veriflow-util/thread.h"
...
#include "../veriflow-util/Template.h"
#include "Trie.h"
#include "Test.h"
...
static pthread_mutex_t veriflowMutex;
...
bool VeriFlow::getAllEquivalenceClasses(vector< EquivalenceClass >& vFinalPacketClasses, vector< vector< Trie* > >& vFinalTries)
{
	vFinalPacketClasses.clear();
	vFinalTries.clear();
	Rule dummyRule;
	dummyRule.type = FORWARDING;
	dummyRule.fieldValue[DL_SRC] = "0:0:0:0:0:0";
	dummyRule.fieldMask[DL_SRC] = "0:0:0:0:0:0";
	dummyRule.fieldValue[DL_DST] = "0:0:0:0:0:0";
	dummyRule.fieldMask[DL_DST] = "0:0:0:0:0:0";
	dummyRule.fieldValue[NW_SRC] = "0.0.0.0";
	dummyRule.fieldMask[NW_SRC] = "0.0.0.0";

	dummyRule.fieldValue[NW_DST] = "0.0.0.0";		
	dummyRule.fieldMask[NW_DST] = "0.0.0.0";
	dummyRule.wildcards = OFPFW_ALL;


	removeRule(dummyRule);
	bool result=getAffectedEquivalenceClasses(dummyRule,OFPFC_ADD,vFinalPacketClasses, vFinalTries);
...
ForwardingGraph* VeriFlow::getForwardingGraph(vector<Trie*> t, EquivalenceClass packetClass)
{
	ForwardingGraph *g=Trie::getForwardingGraph(TP_DST, t, packetClass, stdout);
